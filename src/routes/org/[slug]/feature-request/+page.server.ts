...
export const actions: Actions = {
  submit: async (event) => {
    ...
    logAudit({ userId: locals.user.id, organizationId: organization.id, action: 'FEATURE_REQUEST_SUBMITTED', entityType: 'FeatureRequest', details: { title, category, priority }, ...getRequestInfo(event) });
