...
<div class="max-w-7xl mx-auto">
  <!-- Welcome Banner -->
  <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-6 mb-8 text-white shadow-lg shadow-indigo-500/20">
  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    <div class="stats-card">
      ...
      <div>
        <div class="text-2xl font-bold text-gray-900">{data.stats?.totalTeachers || 0}</div>
    ...
    <div class="stats-card">
      ...
      <div>
        <div class="text-2xl font-bold text-gray-900">{data.stats?.totalStudents || 0}</div>
    ...
    <div class="stats-card">
      ...
      <div>
        <div class="text-2xl font-bold text-gray-900">{data.stats?.totalClasses || 0}</div>
        <div class="text-sm text-gray-500">Classes</div>
      </div>
    </div>

    <div class="stats-card">
      <div class="stats-icon bg-gradient-to-br from-orange-500 to-amber-500">
        <FileText class="w-6 h-6" />
      </div>
      <div>
        <div class="text-2xl font-bold text-gray-900">{data.stats?.totalTests || 0}</div>
  ...
  <div class="grid lg:grid-cols-2 gap-6">
    ...
    <div class="card">
      <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <a href="/org/{data.organization.slug}/teachers" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium flex items-center gap-1">
    ...
    <div class="card">
      <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <a href="/org/{data.organization.slug}/classes" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium flex items-center gap-1">
          View All <ChevronRight class="w-4 h-4" />
        </a>
      </div>
      <div class="p-5">
  ...
  <div class="mt-8 card p-5">
    ...
    <div class="grid sm:grid-cols-3 gap-4">
      <a href="/org/{data.organization.slug}/teachers" class="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50/50 transition-all group">
      ...
      <a href="/org/{data.organization.slug}/classes" class="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50/50 transition-all group">
      ...
      <a href="/org/{data.organization.slug}/settings" class="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group">
