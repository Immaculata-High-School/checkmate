<script lang="ts">
  ...
  let selectedTab = $state<'overview' | 'users' | 'logs'>('overview');
...
<div class="max-w-7xl mx-auto">
  ...
  <div class="flex items-center justify-between mb-6">
    <div>
      ...
      <p class="text-gray-500 mt-1">Monitor AI usage, tokens, and costs for your organization</p>
    </div>
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
    <div class="stat-card">
      <div class="stat-value text-indigo-600">{formatNumber(data.stats.totalRequests)}</div>
    ...
    <div class="stat-card">
      <div class="stat-value text-purple-600">{formatCost(data.stats.last7Days.cost)}</div>
            ...
            <div class="h-48 flex items-end gap-1">
              {#each data.dailyUsage as day}
                ...
                <div class="flex-1 group relative">
                  <div
                    class="bg-indigo-500 rounded-t transition-all hover:bg-indigo-600"
