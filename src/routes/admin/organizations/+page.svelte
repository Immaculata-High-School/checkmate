    ...
    <div class="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
      ...
      <form method="POST" action="?/create" use:enhance={() => {
        ...
        <div class="p-6 space-y-4">
          ...
          <!-- PowerSchool Integration Toggle -->
          <div class="p-4 border border-gray-200 rounded-lg">
            <div class="flex items-center justify-between">
              <div>
                <div class="font-medium text-gray-900">PowerSchool Integration</div>
                <p class="text-sm text-gray-500">Enable PowerSchool grade sync features for this organization</p>
              </div>
              <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" name="powerSchoolEnabled" value="true" checked class="sr-only peer" />
